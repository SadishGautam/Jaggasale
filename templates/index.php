                ...
                <div class="card">
                    <div class="card-img"style="position: relative;overflow:hidden;">
                        <div class="img-box"style="height:210px">
                            <img src="{{object.image.url}}" height="100%" width="100%">
                        </div>
                        <a href="details.php"><div class="img-overlay"></div></a>
                        <div class="badge badge1 px-2 py-1 badge-success">{{object.get_label_display}}</div>
                        <div class="badge badge2 px-2 py-1"><i class="fas fa-camera"></i> {{object.picture_count}}</div>
                    ...
                    <div class="container px-4">
                        <div class="card-title mt-3">
                            <a href="details.php" >{{object.title}}</a>
                        </div>
                        <div class="card-content mt-3">
                           <div class="row room">
                               <div class="col-lg-6">
                                   <p><i class="fas fa-home"></i> {{object.get_category_display}}</p>
                               </div>
                               <div class="col-lg-6">
                                   <p><i class="fas fa-ruler-combined"></i> {{object.area}} sq ft</p>
                               </div>
                               <div class="col-lg-6">
                                    <p><i class="fas fa-bed"></i> {{object.rooms}} Rooms</p>
                                </div>
                                <div class="col-lg-6">
                                    <p> <i class="fas fa-clock"></i> {{object.date}}</p>
                                </div>
                           </div>
                           <hr style="border-top:.5px solid lightgrey">
                           <div class="car-footer pb-4">
                               
                                <strike>Rs. {{object.discount_price}}</strike>  
                                
                                <span style="color:black;font-weight:bold;" class="ml-3">Rs. {{object.price}}</span> 
    ...
    {% for object in object_list %}
        <div class="item sold-item">
            <div class="card mb-5" style="padding:15px;">
                <div class="card-img"style="position: relative;overflow:hidden;">
                    <div class="img-box">
                        <img src="{{object.image.url}}" height="230px">
                    </div>
